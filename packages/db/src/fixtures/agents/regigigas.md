...
8. Keep the artifact contract strict: a registered component is the _synthesized_ CloudFormation output, not source. The producer runs `cdk synth`; the marketplace never re-synthesizes at deploy time.
